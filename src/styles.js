const styles = {
  ...
  heroHeadText:
    "head-text font-black lg:text-[80px] sm:text-[56px] xs:text-[48px] text-[36px] lg:leading-[98px]",
  heroSubText:
    "sub-text font-medium lg:text-[44px] sm:text-[36px] xs:text-[24px] text-[20px] lg:leading-[68px]",
  heroContent:
  ...
  aboutTopic:
    "sub-text font-medium lg:text-[20px] sm:text-[17px] xs:text-[16px] text-[17px] lg:leading-[30px]",
  aboutContent:
