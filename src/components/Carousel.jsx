...
//     screenScale = [2.2, 2.2, 2.2];
//     screenPosition = [-0.1, -2.2, 1];
//   } else if (aspectRatio < 1.5) { //min 993
//     screenScale = [2.6, 2.6, 2.6];
//     screenPosition = [0.2, -3, -2];
//   } else {
//     screenScale = [4.2, 4.2, 4.2];
...
//   const [modelRotationKey, setModelRotationKey] = useState(0);
//   const [lastAction, setLastAction] = useState(null); // Track the last action
//   const { isReadMode } = useAccessibility(); // for read mode
...
//       window.removeEventListener('keydown', handleKeyDown);
//     };
//   }, [angle, sensitivity, isReadMode]);

//   // const handleSlideClick = (link) => {
//   //   navigate(link); // Use navigate to change routes
//   // };

//   // Function to handle navigation in read mode
//   const handleNavigation = (link) => {
//     navigate(link);
//   };

//   return (
//     <div className={`carousel-container ${isReadMode ? 'read-mode' : ''}`}>

//       {isReadMode ? (
//         <div className="read-mode-content">
//           {carouselItems.map((item, i) => (
//             <div key={i} className="slide-content">
//               <h1 className="content-subheading mb-2">{item.title}</h1>
//               <h2 className="content-text mb-2">{item.subtitle}</h2>
//               {item.list && item.list.length > 0 && (
//                 <ul className="item-list mb-4">
//                   {item.list.map((listItem, index) => (
//                     <li key={index} className="content-text list-item">{listItem}</li>
//                   ))}
//                 </ul>
//               )}
//               <p className="content-text absolute"
...
//           {messageVisible && (
//             <>
//               <div className="overlay-message desktop-message">
//                 <p>
//                   Scroll or use arrow keys to explore
//                 </p>
//               </div>

//               <div className="overlay-message mobile-message">
//                 <p>
//                   Swipe to explore
//                 </p>
//               </div>
