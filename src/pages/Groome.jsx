...
const Groome = () => {
  ...
  return (
    ...
    <div className={`mt-12`}>
      ...
      <div className="mt-10">
        <h3 className={`${styles.caseStudyTopicText}`}>Project overview</h3>
      ...
      <div className="mt-10">
        <h3 className={`${styles.caseStudyTopicText}`}>Exploring The Problem</h3>

        <h4 className={`${styles.caseStudySubTopicText} square-before`}>Project Scope</h4>
        <p className={`${styles.caseStudyContent}`}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit,
          sed do eiusmod tempor incididunt ut labore et dolore magna
          aliqua.
        ...
        <h4 className={`${styles.caseStudySubTopicText} square-before`}>Problem Statement</h4>
        <p className={`${styles.caseStudyContent}`}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit,
          sed do eiusmod tempor incididunt ut labore et dolore magna
          aliqua.
      ...
      <div className="mt-10">
        ...
        <h4 className={`${styles.caseStudySubTopicText} square-before`}>Stakeholder Interviews</h4>
        <p className={`${styles.caseStudyContent}`}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit,
          sed do eiusmod tempor incididunt ut labore et dolore magna
        </p>

        <h4 className={`${styles.caseStudySubTopicText} square-before`}>Userflows</h4>
        <p className={`${styles.caseStudyContent}`}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit,
          sed do eiusmod tempor incididunt ut labore et dolore magna
        </p>
